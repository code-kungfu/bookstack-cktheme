    ...
    <div component="permissions-table">
        ...
        <div class="toggle-switch-list grid half mt-m">
            ...
            <div>
                ...
                <div>@include('settings.roles.parts.checkbox', ['permission' => 'view-recent-activity', 'label' => 'Show recent activity'])</div>
                <div>@include('settings.roles.parts.checkbox', ['permission' => 'view-extended-activity', 'label' => 'Show extended activity'])</div>
