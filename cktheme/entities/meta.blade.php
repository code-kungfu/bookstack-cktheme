<div class="entity-meta">
    ...
    @if ($entity->isA('page'))
    	@if (userCan('view-extended-activity'))
      ...
      @else	
        <div class="entity-meta-item">
        		@icon('history')        		
        		{{ trans('entities.meta_revision', ['revisionCount' => $entity->revision_count]) }}
        </div>
      @endif
    @endif
